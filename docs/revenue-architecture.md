# Revenue Architecture - beaver-study-orchestrator
...
| Repo-specific launch path | Cloudflare Pages demo, FastAPI or Workers API, Supabase auth/Postgres, OpenRouter/Groq for plan generation with cached templates |

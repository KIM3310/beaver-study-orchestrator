# Service Growth Model - beaver-study-orchestrator
...
| Field | Decision |
|---|---|
| Service type | Education planning and orchestration |
| Primary reader or buyer | Study coaches, cohorts, or education teams if a narrow niche is selected. |
| Wedge | Single cohort workflow validation. |

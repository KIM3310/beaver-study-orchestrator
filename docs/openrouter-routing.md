...
| Lane | Model | Purpose |
|---|---|---|
| Primary | `google/gemini-3.1-flash-lite` | Study plan explanation, coaching copy, and lightweight schedule what-if summaries. |
| Fallback | `mistralai/mistral-small-2603` | Higher reliability or alternate-provider path when the primary model is unavailable. |
...
OPENROUTER_HTTP_REFERER=https://beaver-study-orchestrator.pages.dev
OPENROUTER_APP_TITLE=beaver-study-orchestrator
```
